...
<div class="wrap">
	...
	<div class="wprps-notice">
		<a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=17370&edd_options[price_id]=3&ref=wposthemeplugin" target="_blank">Upgrade</a> a plugin within a minute and unloack many features now!!!
	</div>
	...
	<table class="wpos-plugin-pricing-table">
		...
		<tfoot>
			<tr>
				<th></th>
				<td></td>
				<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=17370&edd_options[price_id]=3&ref=wposthemeplugin" target="_blank">Upgrade Now</a></td>
			</tr>
		</tfoot>
		...
		<tbody>
			...
			<tr>
				<th>Masonry style<span> Masonry style for image gallery.</span></th>
				<td><i class="dashicons dashicons-no-alt"></i></td>
				<td><i class="dashicons dashicons-yes"></i></td>
			</tr>
			<tr>
